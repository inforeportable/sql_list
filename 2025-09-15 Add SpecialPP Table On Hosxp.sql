-- 205.รหัสบริการส่งเสริมป้องกันเฉพาะ (แฟ้มSpecialPP)31Jan68
 
DELETE FROM pp_special_code ;
INSERT IGNORE INTO pp_special_code (code,name) values 
...
("1B118","การตรวจคัดกรองความเสี่ยง / เฝ้าระวัง ในประชากรวัยแรงงาน อื่น ๆ"),
("1B119","การตรวจคัดกรองความเสี่ยง / เฝ้าระวัง ในประชากรวัยแรงงาน ไม่ระบุรายละเอียด"),
...
("1B570","ผู้ติดบุหรี่ใช้บุหรี่ซิกาแรต"),
("1B571","ผู้ติดบุหรี่ใช้บุหรี่มวนเอง/ยาเส้น"),
("1B572","ผู้ติดบุหรี่ใช้บุหรี่ไฟฟ้า/บารากูไฟฟ้า/เวป (Vapes)/พอด (Pod)"),
("1B578","ผู้ติดบุหรี่ใช้บุหรี่แบบอื่น ๆ"),
...
("1C21","การปรับเปลี่ยนพฤติกรรมการบริโภคอาหารอย่างเข้มข้น"),
...
("1I20","การให้บริการป้องกันและควบคุมโรคไม่ติดต่อให้เข้าสู่ระยะสงบ"),
...
SELECT 
@max_id := @max_id  +1  as pp_special_type_id,
concat(pp_special_code.`code`,' ',pp_special_code.`name`)  as pp_special_type_name,
pp_special_code.`code` as pp_special_code
FROM 
pp_special_code,
(SELECT @max_id := IFNULL(max(pp_special_type_id),0) FROM pp_special_type) as v
WHERE
pp_special_code.`code` NOT IN 
(SELECT pp_special_code FROM pp_special_type) ;
